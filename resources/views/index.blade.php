                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-gray-900 flex flex-col min-w-0 flex-1">
                                <a href="{{route('profile',['user'=>$post->username])}}" class="hover:underline font-semibold line-clamp-1">
                                    {{$post->name}}
                                </a>

                                <a href="{{route('profile',['user'=>$post->username])}}" class="hover:underline text-sm text-gray-500 line-clamp-1">
                                    @ {{$post->username}}
                                </a>
                            </div>
                            <!-- /User Info -->
